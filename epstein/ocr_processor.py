...
class OCRProcessor:
    ...
    def add_task(self, input_path: Path, output_path: Optional[Path] = None) -> str:
        """
        Add OCR task
    ...
    def extract_text(self, pdf_path: Path) -> Tuple[bool, str, Optional[str]]:
        """
    ...
    def run_ocr(self, task_id: str) -> Tuple[bool, Optional[str]]:
        """
    ...
    def run_ocr_with_retry(self, task_id: str) -> Tuple[bool, Optional[str]]:
        """
