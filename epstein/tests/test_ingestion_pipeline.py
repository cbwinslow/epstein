...
class TestUtilityFunctions:
    ...
    def test_file_hash_generation(self):
        ...
        assert hash_result == hashlib.sha256("Test content for hashing".encode()).hexdigest()
...
class TestPerformance:
    ...
    def test_memory_management(self, test_pipeline):
        ...
        initial_memory = test_pipeline._get_status()
        ...
        final_memory = test_pipeline._get_status()
