...
class AdvancedAnalysisTools:
    ...
    async def extract_complex_entities(self, text: str, entity_types: List[str], advanced_options: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        """
    ...
    async def build_advanced_knowledge_graph(self, text: str, entity_types: List[str], graph_options: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        """
