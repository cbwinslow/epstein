...
class AgentTelemetry:
    ...
    def _setup_tracing(self, resource: Resource, console: bool, otlp: bool, endpoint: Optional[str]):
    ...
    def _setup_metrics(self, resource: Resource, console: bool, otlp: bool, endpoint: Optional[str]):
...
def get_telemetry(service_name: str = "epstein-multi-agent-system",
                 enable_console_export: bool = True,
                 enable_otlp_export: bool = False,
                 otlp_endpoint: Optional[str] = None) -> AgentTelemetry:
    """
