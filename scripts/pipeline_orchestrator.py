...
from epstein.file_organizer import FileOrganizer, FileCategory
...
class PipelineOrchestrator:
    ...
    def add_download_tasks_from_doj(
        self,
        dataset_numbers: Optional[List[int]] = None
    ) -> List[str]:
        """
    ...
    def run_download_phase(self, task_ids: Optional[List[str]] = None) -> bool:
        """
        Run download phase
